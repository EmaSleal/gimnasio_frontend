...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, NavbarComponent, FooterComponent, MatSidenavModule, SidebarModule, ButtonModule,ToolbarModule, SplitButtonModule, InputTextModule, PanelMenuModule,RippleModule, AvatarModule, StyleClassModule, DockModule  
],
...
export class AppComponent implements OnInit{
  ...
  routes = signal<MenuItem[]>([
    ...
    },
    {
      ...
      items: [
        { routerLink: 'muscular-group/list', label: 'Listar Grupos Musculares' },
  ...
  constructor(private loginservice: LoginService, private primengConfig: PrimeNGConfig, private windowService: WindowService){
...
this.screenWidth = this.windowService.getScreenWidth();
